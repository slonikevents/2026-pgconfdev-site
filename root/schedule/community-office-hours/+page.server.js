...
const wednesdayRoster = [
  {
    ...
    note: 'Mark Wong',
    description:
      'Did you report a bug?  Contribute a patch?  Update documentation?  Maybe you are mentioned in the release notes.  See <a href="https://wiki.postgresql.org/wiki/Contributor_Gifts">https://wiki.postgresql.org/wiki/Contributor_Gifts</a> for details.',
    slot: new Slot(
  ...
  },
  {
    ...
    note: 'Stacey Haysler',
    description:
      "Interested in volunteering with the PostgreSQL Project, but don't know where to start? Meet us at the Community Booth to find out the many opportunities we have for becoming involved, and sign up!",
    slot: new Slot(
      Temporal.PlainDateTime.from('2026-05-20T14:30:00'),
  ...
  },
  {
    ...
    note: 'Mark Wong',
    description:
      'PostgreSQL can sometimes be seen in the exhibition halls of various events networking with other communities and passing out swag. This session covers the volunteer effort that makes this happen including:\n<ul>\n<li>planning & scheduling\n<li>staffing\n<li>budgeting\n<li>swag\n</ul>\nPlease come to help us do better, discuss any of these topics, and get involved!',
    slot: new Slot(
      Temporal.PlainDateTime.from('2026-05-20T16:00:00'),
